...
void init(rack::Plugin *p) {
  ...
  // module name
  p->addModel(createModel<SwitchedMultipleWidget>(
      "CastleRocktronics", "CR-V01_SwitchedMultiple", "Switched Multiple",
      UTILITY_TAG, MULTIPLE_TAG));
  p->addModel(createModel<CrossfaderWidget>("CastleRocktronics",
                                            "CR-V02_Crossfader", "Crossfader",
